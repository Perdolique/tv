/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 4e9edc02350f57a10e8ea8aff961f3cd)
// Runtime types generated with workerd@1.20260908.1 2026-09-04 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DATABASE: Hyperdrive;
	EMAIL: SendEmail;
	REGISTRATION_EMAIL_RATE_LIMITER: RateLimit;
	REGISTRATION_ACTIVATION_RATE_LIMITER: RateLimit;
	SIGN_IN_RATE_LIMITER: RateLimit;
	IMAGES: ImagesBinding;
	WEB_ORIGIN: "https://tv-staging.perd.dev" | "https://tv.perd.dev";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		SIGN_IN_RATE_LIMITER: RateLimit;
		IMAGES: ImagesBinding;
		WEB_ORIGIN: "https://tv-staging.perd.dev";
		TURNSTILE_SECRET: string;
		TMDB_READ_ACCESS_TOKEN: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEB_ORIGIN" | "TURNSTILE_SECRET" | "TMDB_READ_ACCESS_TOKEN">> {}
}
