<template>
  <section :class="$style.component" aria-label="Search results">
    ...
    <div v-if="hasFailure" :class="$style.failure">
      ...
      <AppButton ref="retryButton" :disabled="isLoading" variant="secondary" @click="emit('retry')">Try again</AppButton>
    </div>
...
<script lang="ts" setup>
  ...
  const resultsHeading = useTemplateRef('resultsHeading')
