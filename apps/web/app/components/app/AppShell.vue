<template>
  <div :class="$style.component" :data-authenticated="isAuthenticated" :data-focused="focused">
    ...
    <nav v-if="isAuthenticated" :class="$style.desktopNavigation" aria-label="Main navigation">
      ...
      <NuxtLink :class="$style.navigationLink" to="/dashboard" :aria-current="dashboardCurrent">
...
<script lang="ts" setup>
  ...
  const dashboardCurrent = computed(() => activeDestination === 'dashboard' ? 'page' : undefined)
